...
void GPIO_voidSetPinOutputType(u32 Copy_u32PortID, u32 Copy_u32PinID, u32 Copy_u32Type)
{
	switch(Copy_u32Type)
	    {
	        case OUTPUT_PP:
...
void GPIO_voidSetPinOutputSpeed(u32 Copy_u32PortID, u32 Copy_u32PinID, u32 Copy_u32Speed)
{
...
void GPIO_voidSetPinValue(u32 Copy_u32PortID, u32 Copy_u32PinID, u32 Copy_u32Value)
{
...
{
	/*i/p validation*/
	if((Copy_u8PortId > GPIOC) || (Copy_u8PinId > PIN15) || (Copy_u8AfNumber > AF15))
	{
		/*Do Nothing*/
	}
	else
	{
		if(Copy_u8PinId <= PIN7)
		{
			...
			{
				case GPIOA:	GPIOA_AFRL |= (Copy_u8AfNumber << (Copy_u8PinId*4));
							break;
				case GPIOB:	GPIOB_AFRL |= (Copy_u8AfNumber << (Copy_u8PinId*4));
							break;
				case GPIOC:	GPIOC_AFRL |= (Copy_u8AfNumber << (Copy_u8PinId*4));
							break;
				default:
							break;
			}
		...
		else
		{
			switch(Copy_u8PortId)
			{
				case GPIOA:	GPIOA_AFRH |= (Copy_u8AfNumber << ((Copy_u8PinId % 8)*4));
							break;
				case GPIOB:	GPIOB_AFRH |= (Copy_u8AfNumber << ((Copy_u8PinId % 8)*4));
							break;
				case GPIOC:	GPIOC_AFRH |= (Copy_u8AfNumber << ((Copy_u8PinId % 8)*4));
							break;
				default:
							break;
			}
